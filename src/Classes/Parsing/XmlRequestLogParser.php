...
class XmlRequestLogParser extends AbstractRequestLogParser
{
    public function requestData()
    {
        $xml = $this->loadXmlString($this->requestBody);
        ...
        return $data['Envelope']['Body'] ?? $xml;
    }

    public function responseData()
    {
        $xml = $this->loadXmlString($this->responseBody);
    ...
    protected function loadXmlString(?string $xmlString)
    {
    ...
    /**
     * Took this part of code from https://outlandish.com/blog/tutorial/xml-to-json/
     *
     * @param \SimpleXMLElement $xml
     * @param array             $options
     * @return array
     */
    protected function xmlToArray(\SimpleXMLElement $xml, array $options = []): array
    {
        $defaults = [
